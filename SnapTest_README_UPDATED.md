...
### 1️⃣ 테스트 케이스 생성 (AI 기반)

| 자연어 요청 | 생성된 테스트 |
|-------------|---------------|
| ![요청](demo-images/snap_ai_input.png) | ![결과](demo-images/snap_ai_output.png) |
...
| 실행 중 화면 | 실행 결과 |
|--------------|-----------|
| ![실행 중](demo-images/snap_run.png) | ![결과](demo-images/snap_result.png) |
...
| 대시보드 | 상세 리포트 |
|----------|-------------|
| ![대시보드](demo-images/snap_dashboard.png) | ![리포트](demo-images/snap_report_detail.png) |
